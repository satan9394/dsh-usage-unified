	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			costSource: "pricing from {source}",
		...
		*/
		...
		function Dashboard({ hide, embedded = false }) {
			...
			const body = error ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card, {
							...
							value: (() => {
								const denom = snapshot.allTime.totals.input + snapshot.allTime.totals.cacheRead + snapshot.allTime.totals.cacheWrite;
								return denom > 0 ? `${(snapshot.allTime.totals.cacheRead / denom * 100).toFixed(1)}%` : "—";
							})(),
							accent: "#2da2bb"
						}),
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SmoothTrend, { snapshot }),
