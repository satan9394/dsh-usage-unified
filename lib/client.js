...
`;
		...
		function Heatmap({ snapshot }) {
			...
			const active = (day) => day.tokens > 0 || day.calls > 0;
			const firstActive = all.findIndex(active);
			let lastActive = -1;
			for (let i = all.length - 1; i >= 0; i -= 1) {
				const day = all[i];
				if (day !== void 0 && active(day)) {
					lastActive = i;
					break;
				}
			}
			...
			const mondayOffset = startDate === "" ? 0 : ((/* @__PURE__ */ new Date(`${startDate}T12:00:00`)).getDay() + 6) % 7;
			...
			const monthOf = (date) => lang === "zh" ? `${Number(date.slice(5, 7))}月` : new Intl.DateTimeFormat("en-US", { month: "short" }).format(/* @__PURE__ */ new Date(`${date}T12:00:00`));
			...
			const monthLabels = Array.from({ length: weeks }, (_, week) => {
				...
				return day.date.slice(5, 7) === (week > 0 ? days[(week - 1) * 7]?.date.slice(5, 7) : void 0) ? "" : monthOf(day.date);
			});
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "us-heat-months-row",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: "us-heat-gutter" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "us-heat-months",
							style: { gridTemplateColumns: columns },
							children: monthLabels.map((label, week) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: label }, week))
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "us-heat-caption",
						children: [
							formatDateLabel(days[0]?.date ?? "", lang),
							" → ",
							formatDateLabel(days[days.length - 1]?.date ?? "", lang),
							" · ",
							t("activeDays"),
							" ",
							snapshot.days.filter(active).length
						]
					})
				]
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								style: {
									left: `${leftPercent}%`,
									top: `${pointPercent}%`,
									transform: below ? "translate(-50%, 16%)" : "translate(-50%, -112%)"
								},
		...
		function Dashboard({ hide, embedded = false }) {
			...
			const body = error ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				range !== "all" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SmoothTrend, { snapshot }),
