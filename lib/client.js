...
`;
		...
		function SmoothTrend({ snapshot }) {
			...
			const yAt = (value) => 270 - value / max * plotH;
			const smooth = (get) => {
			...
			const areaPath = totalPath === "" ? "" : `${totalPath} L ${xAt(days.length - 1).toFixed(1)} ${270 .toFixed(1)} L ${xAt(0).toFixed(1)} ${270 .toFixed(1)} Z`;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), hover !== null && hoverDay !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "us-trend-tip",
							style: {
								left: `${xAt(hover) / W * 100}%`,
								top: `${yAt(hoverDay.tokens) / H * 100}%`
							},
