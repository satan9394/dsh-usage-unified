...
`;
		...
		*/
		...
		function SmoothTrend({ snapshot, note }) {
			...
			const days = (0, react.useMemo)(() => gapFillDays(snapshot.days), [snapshot.days]);
			const W = 1e3;
			const H = 380;
			const padL = 56;
			const padT = 16;
			...
			const series = [
				...
				},
				{
					...
					label: t("cacheRead"),
					color: "#f59e0b",
					get: (day) => day.cacheRead
				}
			];
			const max = Math.max(1, ...days.map((day) => day.tokens));
			const xAt = (index) => padL + (days.length <= 1 ? plotW / 2 : index / (days.length - 1) * plotW);
			const yAt = (value) => 350 - value / max * plotH;
			const smooth = (get) => {
				if (days.length === 0) return "";
				const pts = days.map((day, index) => [xAt(index), yAt(get(day))]);
			...
			const areaPath = totalPath === "" ? "" : `${totalPath} L ${xAt(days.length - 1).toFixed(1)} ${350 .toFixed(1)} L ${xAt(0).toFixed(1)} ${350 .toFixed(1)} Z`;
			...
			const hoverDay = hover === null ? void 0 : days[hover];
			const onMove = (event) => {
				const rect = event.currentTarget.getBoundingClientRect();
				if (rect.width === 0 || days.length === 0 || false) return;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Panel, {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
						...
						children: [
							...
							ticks.map((index) => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
									...
									children: formatDateLabel(day.date, lang)
								}, index);
							}),
							...
							hover !== null && hoverDay !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("line", {
					...
					}), hover !== null && hoverDay !== void 0 && tipAt !== null && (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						"data-usage-stats": true,
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: formatDateLabel(hoverDay.date, lang) }), series.map((item) => off[item.id] ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: item.color } }), item.label] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: compact(item.get(hoverDay), numberLocale) })] }, item.id))]
					}), document.body)]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		...
		function CallsPanel({ snapshot, range, scope, workspace, session, onClearSession, custom }) {
			const { t, numberLocale } = useLocale();
